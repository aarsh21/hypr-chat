...
// Type assertion needed due to prosemirror-schema-list having its own nested prosemirror-model dependency.
// This causes type incompatibility between the two versions at build time, but works correctly at runtime.
const diffSchema = new Schema({
  nodes: addListNodes(
    schema.spec.nodes as Parameters<typeof addListNodes>[0],
    "paragraph block*",
    "block"
  ) as unknown as OrderedMap<NodeSpec>,
